...
using RoverHello.Infrastructure.Common.Email.Models.EmailViewModels;
using RoverHello.Infrastructure.Common.Templates.Models;

namespace RoverHello.Infrastructure.Common.Email.Services;
